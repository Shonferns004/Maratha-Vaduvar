...
const Feature = () => {
  return (
    <div className="px-4 pt-30 py-16 mx-auto sm:max-w-xl md:max-w-full  md:px-24 lg:px-40 lg:py-40 dark:bg-gray-100 dark:text-gray-800">
	<h2 className="mb-10 text-4xl font-bold leading-none text-center">What do we have to offer?</h2>
